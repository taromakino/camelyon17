...
def make_model(args):
    ...
    if args.task == Task.ERM:
        ...
        return VAE(args.task, args.z_size, args.rank, args.h_sizes, args.y_mult, args.beta, args.reg_mult,
            args.init_sd, args.lr, args.weight_decay, args.lr_infer, args.n_infer_steps)
    else:
